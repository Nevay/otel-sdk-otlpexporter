...
/**
 * @implements OtlpGrpcExporter<ReadableSpan, ExportTraceServiceRequest, ExportTraceServiceResponse>
 */
final class OtlpGrpcSpanExporter extends OtlpGrpcExporter implements SpanExporter {
    ...
    public function __construct(
        ...
        int $maxResponseBodySize = 4 * 1024 * 1024,
        ...
        parent::__construct(
            ...
            $client,
            $endpoint->withPath('/opentelemetry.proto.collector.trace.v1.TraceService/Export'),
            $compression,
            $headers,
            $timeout,
            $retryDelay,
