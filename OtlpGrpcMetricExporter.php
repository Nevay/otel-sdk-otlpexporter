 ...
 */
final class OtlpGrpcMetricExporter extends OtlpGrpcExporter implements MetricExporter {
    ...
    public function __construct(
        ...
        parent::__construct(
            ...
            $client,
            $endpoint->withPath('/opentelemetry.proto.collector.metrics.v1.MetricsService/Export'),
            $compression,
            $headers,
            $timeout,
            $retryDelay,
